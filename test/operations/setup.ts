...
} from '../../src/operations/services';
import {
  CodeSendEvent,
  CodeSendPublisherPort,
} from '../../src/operations/interfaces';
import { HashCodeVerifier } from '../../src/operations/services';
import { TotpVerifier } from '../../src/operations/services';
import { VerifierRegistry } from '../../src/operations/services';
...
export class CapturingPublisher implements CodeSendPublisherPort {
  ...
  constructor(private readonly _ds: FakeDataSource) {}
  ...
  publish(event: CodeSendEvent): Promise<void> {
    ...
    this.publishedInTransaction.push(this._ds.inTransaction);
